...
#        --smooth_rate $smooth_rate
    ...
    delta_file_name="spgd_${num_images}_${epoch}epoch_${batch_size}batch.pth"
    ...
    # 评估
    CUDA_VISIBLE_DEVICES=0 python cifar_eval.py \
        --data_dir "$data_dir_val" \
        --uaps_save "$uaps_save_path_eval" \
        --batch_size $eval_batch_size  2>&1 | tee -a "$uaps_save_path2"
