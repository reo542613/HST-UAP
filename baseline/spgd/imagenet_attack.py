...
def main(args):
    ...
    torch.manual_seed(0)
    loader = torch.utils.data.DataLoader(X,batch_size=batch_size,shuffle=True,num_workers=12)
    loader_eval = torch.utils.data.DataLoader(X,batch_size=100,shuffle=True,num_workers=12)
