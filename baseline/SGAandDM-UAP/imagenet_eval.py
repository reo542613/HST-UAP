...
def main(args):
    ...
    #loader = loader_imgnet(dir_data, args.number, batch_size, model_dimension,center_crop)
    ...
    if args.model_name.lower() == 'all':
        model_list = [
            ...
            'ViT-B',  'DeiT-S', 'DeiT-B', 'Swin-T', 'Swin-S', 'Swin-B'
        ]
    else:
...
def parse_arguments(argv):
    ...
    parser.add_argument('--number', type=int, default=50000, help='test data')
